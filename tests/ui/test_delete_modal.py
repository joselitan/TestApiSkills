...
def test_delete_modal_opens_correctly(authenticated_page: Page):
    ...
    expect(page.locator("#deleteEntryComment")).to_contain_text("Testing delete modal functionality")
    
    # Verify warning text is present
    expect(page.locator(".warning-text")).to_contain_text("This action cannot be undone")
...
def test_multiple_delete_modals_not_interfering(authenticated_page: Page):
    ...
    expect(page.locator("#deleteModal")).to_be_visible()
    expect(page.locator("#deleteEntryName")).to_contain_text("Second Delete User")  # Should be the most recent
