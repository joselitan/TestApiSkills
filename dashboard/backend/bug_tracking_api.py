...
from models import BugReport, DatabaseManager
...
def test_github_integration():
    ...
    try:
        ...
        response = requests.get(
            f'https://api.github.com/repos/{data["repo"]}', headers=headers, timeout=10
        )
...
def send_slack_notification():
    ...
    try:
        ...
        response = requests.post(data["webhook_url"], json=slack_payload, timeout=10)
