...
def seed_database():
    ...
    dummy_data = [
        ...
        ("Grace Hopper", "grace@navy.mil", "It's easier to ask forgiveness than permission."),
        ("Henry Ford", "henry@ford.com", "Whether you think you can or can't, you're right."),
        ...
        ("Peter Parker", "peter@dailybugle.com", "With great power comes great responsibility."),
        ("Quinn Fabray", "quinn@mckinley.edu", "I'm more than just a pretty face."),
        ("Rachel Green", "rachel@centralperk.com", "It's like all my life everyone has told me..."),
        ...
        ("Zoe Washburne", "zoe@serenity.space", "This is something the Captain has to do for himself.")
    ]
